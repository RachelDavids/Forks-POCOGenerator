...
namespace System.Data
{
	public static partial class DataTableExtensions
	{
		...
		private static T[] ToEnumerable<T>(DataTable table, Func<T> instanceHandler, ValueHandler getValue)
		{
			...
			IEnumerable<(string ColumnName, Type ColumnType, bool IsField, MemberInfo MemberInfo)> columns =
			...
			foreach (DataRow row in table.Rows)
			{
				...
				foreach ((string ColumnName, Type ColumnType, bool IsField, MemberInfo MemberInfo) column in columns)
				{

...
namespace POCOGeneratorUI
{
	public partial class POCOGeneratorForm : Form
	{
		...
		{
			// POCO
			generator.Settings.POCO.Properties = rdbProperties.Checked;
			generator.Settings.POCO.Fields = rdbFields.Checked;
			generator.Settings.POCO.VirtualProperties = chkVirtualProperties.Checked;
			generator.Settings.POCO.OverrideProperties = chkOverrideProperties.Checked;
			generator.Settings.POCO.PartialClass = chkPartialClass.Checked;
			generator.Settings.POCO.StructTypesNullable = chkStructTypesNullable.Checked;
			generator.Settings.POCO.Comments = chkComments.Checked;
			generator.Settings.POCO.CommentsWithoutNull = chkCommentsWithoutNull.Checked;
			generator.Settings.POCO.Using = chkUsing.Checked;
			generator.Settings.POCO.UsingInsideNamespace = chkUsingInsideNamespace.Checked;
			generator.Settings.POCO.Namespace = txtNamespace.Text;
			generator.Settings.POCO.WrapAroundEachClass = false;
			generator.Settings.POCO.Inherit = txtInherit.Text;
			generator.Settings.POCO.ColumnDefaults = chkColumnDefaults.Checked;
			generator.Settings.POCO.NewLineBetweenMembers = chkNewLineBetweenMembers.Checked;
			generator.Settings.POCO.ComplexTypes = chkComplexTypes.Checked;
			generator.Settings.POCO.EnumSQLTypeToString = rdbEnumSQLTypeToString.Checked;
			generator.Settings.POCO.EnumSQLTypeToEnumUShort = rdbEnumSQLTypeToEnumUShort.Checked;
			generator.Settings.POCO.EnumSQLTypeToEnumInt = rdbEnumSQLTypeToEnumInt.Checked;
			generator.Settings.POCO.Tab = "    ";

			// Class Name
			generator.Settings.ClassName.Singular = chkSingular.Checked;
			generator.Settings.ClassName.IncludeDB = chkIncludeDB.Checked;
			generator.Settings.ClassName.DBSeparator = txtDBSeparator.Text;
			generator.Settings.ClassName.IncludeSchema = chkIncludeSchema.Checked;
			generator.Settings.ClassName.IgnoreDboSchema = chkIgnoreDboSchema.Checked;
			generator.Settings.ClassName.SchemaSeparator = txtSchemaSeparator.Text;
			generator.Settings.ClassName.WordsSeparator = txtWordsSeparator.Text;
			generator.Settings.ClassName.CamelCase = chkCamelCase.Checked;
			generator.Settings.ClassName.UpperCase = chkUpperCase.Checked;
			generator.Settings.ClassName.LowerCase = chkLowerCase.Checked;
			generator.Settings.ClassName.Search = txtSearch.Text;
			generator.Settings.ClassName.Replace = txtReplace.Text;
			generator.Settings.ClassName.SearchIgnoreCase = chkSearchIgnoreCase.Checked;
			generator.Settings.ClassName.FixedClassName = txtFixedClassName.Text;
			generator.Settings.ClassName.Prefix = txtPrefix.Text;
			generator.Settings.ClassName.Suffix = txtSuffix.Text;

			// Navigation Properties
			generator.Settings.NavigationProperties.Enable = chkNavigationProperties.Checked;
			generator.Settings.NavigationProperties.VirtualNavigationProperties = chkVirtualNavigationProperties.Checked;
			generator.Settings.NavigationProperties.OverrideNavigationProperties = chkOverrideNavigationProperties.Checked;
			generator.Settings.NavigationProperties.ManyToManyJoinTable = chkManyToManyJoinTable.Checked;
			generator.Settings.NavigationProperties.Comments = chkNavigationPropertiesComments.Checked;
			generator.Settings.NavigationProperties.ListNavigationProperties = rdbListNavigationProperties.Checked;
			generator.Settings.NavigationProperties.IListNavigationProperties = rdbIListNavigationProperties.Checked;
			generator.Settings.NavigationProperties.ICollectionNavigationProperties = rdbICollectionNavigationProperties.Checked;
			generator.Settings.NavigationProperties.IEnumerableNavigationProperties = rdbIEnumerableNavigationProperties.Checked;

			// EF Annotations
			generator.Settings.EFAnnotations.Enable = chkEF.Checked;
			generator.Settings.EFAnnotations.Column = chkEFColumn.Checked;
			generator.Settings.EFAnnotations.Required = chkEFRequired.Checked;
			generator.Settings.EFAnnotations.RequiredWithErrorMessage = chkEFRequiredWithErrorMessage.Checked;
			generator.Settings.EFAnnotations.ConcurrencyCheck = chkEFConcurrencyCheck.Checked;
			generator.Settings.EFAnnotations.StringLength = chkEFStringLength.Checked;
			generator.Settings.EFAnnotations.Display = chkEFDisplay.Checked;
			generator.Settings.EFAnnotations.Description = chkEFDescription.Checked;
			generator.Settings.EFAnnotations.ComplexType = chkEFComplexType.Checked;
			generator.Settings.EFAnnotations.Index = chkEFIndex.Checked;
			generator.Settings.EFAnnotations.ForeignKeyAndInverseProperty = chkEFForeignKeyAndInverseProperty.Checked;
		}
		...
		private void BuildServerTree()
		{
			try
			{
				...
				generator.ServerBuilt += serverBuilt;
				...
				SetFormControls(generator.Support.SupportSchema, generator.Support.SupportTVPs, generator.Support.SupportEnumDataType);
		...
		private void HandleGeneratorError(GeneratorResults results)
		{
			...
			if (generator != null && String.IsNullOrEmpty(generator.Settings.Connection.ConnectionString) == false)
			{
				errorMessage += Environment.NewLine + Environment.NewLine + "CONNECTION STRING: " + generator.Settings.Connection.ConnectionString;
			}

			if (generator != null && generator.Error != null)
			{
				errorMessage += Environment.NewLine + Environment.NewLine + generator.Error.GetUnhandledExceptionErrorMessage();
				statusErrorMessage += " ERROR: " + generator.Error.Message;
			}
		...
		private void BuildDbObjectsNode(TreeNode databaseNode, string dbObjectsName, IEnumerable<POCOGenerator.Objects.IDbObject> dbObjects)
		{
			if (dbObjects.Any())
			{
...
e.Node.Tag is not null and (Database or
		...
		private void ChangeCheckDatabaseNode(TreeNode databaseNode)
		{
			...
			{
				if (isCheckedTables == false || isCheckedViews == false || isCheckedProcedures == false || isCheckedFunctions == false || isCheckedTVPs == false)
				{
			...
			if (selectedNode != null && selectedNode.Tag != null)
			{
				if (selectedNode.Tag is Database database)
				{
					if (database.Errors.Any())
					{
						...
						txtPocoEditor.SelectionColor = generator.Settings.SyntaxHighlight.Error;
						txtPocoEditor.SelectedText = String.Join(Environment.NewLine + Environment.NewLine, database.Errors);
						txtPocoEditor.SelectionColor = generator.Settings.SyntaxHighlight.Text;
					}
				}
			}
		}
		...
		private GeneratorResults GeneratePOCOs(bool forceGeneratingPOCOs = false, bool isExport = false, Action<IGenerator> BeforeGeneratePOCOs = null, Action<IGenerator> AfterGeneratePOCOs = null)
		{
			...
			void databaseGenerating(object sendeer, DatabaseGeneratingEventArgs e) => e.Skip = selectedDatabases.Contains(e.Database) == false;
			...
			void complexTypeTableGenerating(object sender, ComplexTypeTableGeneratingEventArgs e) => e.Skip = selectedComplexTypeTables.Contains(e.ComplexTypeTable) == false;
			...
			void procedureGenerating(object sender, ProcedureGeneratingEventArgs e) => e.Skip = selectedProcedures.Contains(e.Procedure) == false;
			...
			void functionGenerating(object sender, FunctionGeneratingEventArgs e) => e.Skip = selectedFunctions.Contains(e.Function) == false;
			...
			generator.DatabaseGenerating += databaseGenerating;
			generator.TablesGenerating += tablesGenerating;
			generator.TableGenerating += tableGenerating;
			generator.TableGenerated += tableGenerated;
			generator.ComplexTypeTablesGenerating += complexTypeTablesGenerating;
			generator.ComplexTypeTableGenerating += complexTypeTableGenerating;
			generator.ComplexTypeTableGenerated += complexTypeTableGenerated;
			generator.ViewsGenerating += viewsGenerating;
			generator.ViewGenerating += viewGenerating;
			generator.ViewGenerated += viewGenerated;
			generator.ProceduresGenerating += proceduresGenerating;
			generator.ProcedureGenerating += procedureGenerating;
			generator.ProcedureGenerated += procedureGenerated;
			generator.FunctionsGenerating += functionsGenerating;
			generator.FunctionGenerating += functionGenerating;
			generator.FunctionGenerated += functionGenerated;
			generator.TVPsGenerating += tvpsGenerating;
			generator.TVPGenerating += tvpGenerating;
			generator.TVPGenerated += tvpGenerated;
			generator.DatabaseGenerated += databaseGenerated;

			SetGeneratorSettings();

			BeforeGeneratePOCOs?.Invoke(generator);

			GeneratorResults results = generator.GeneratePOCOs();

			AfterGeneratePOCOs?.Invoke(generator);
		...
		private TreeNode GetSelectedNode()
		{
			...
			{
				return selectedNode.Tag is IEnumerable<FunctionParameter>
					? selectedNode.Parent
									...
									: selectedNode.Tag is IEnumerable<FunctionColumn>
													...
													: selectedNode.Tag is FunctionColumn
																	...
																	: selectedNode.Tag is IEnumerable<TVPColumn>
																					? selectedNode.Parent
																					: selectedNode.Tag is TVPColumn ? selectedNode.Parent.Parent : null;
			}
		}
		...
		private void filterSettingsToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			FilterSettingsForm filterSettingsForm = new(filterSettings, generator.Support.SupportSchema);
		...
		private bool IsMatchFilter(POCOGenerator.Objects.IDbObject dbObject, FilterSettings filterSettings)
		{
			...
			if (generator.Support.SupportSchema)
			{
		...
		{
			if (generator != null && generator.Support.SupportEnumDataType && rdbEnumSQLTypeToString.Checked)
			{
				POCOOptionChanged();
			}
		}
		...
		{
			if (generator != null && generator.Support.SupportEnumDataType && rdbEnumSQLTypeToEnumUShort.Checked)
			{
				POCOOptionChanged();
			}
		}
		...
		{
			if (generator != null && generator.Support.SupportEnumDataType && rdbEnumSQLTypeToEnumInt.Checked)
			{
				POCOOptionChanged();
			}
		}
		...
		private void btnExport_Click(object sender, EventArgs e)
		{
			...
			{
				generator.RedirectTo(txtPocoEditor);
													 ...
													 POCOGenerator.Objects.IDbObject dbObject)
		{
			...
			else if (selectedDbObjectsCount > 1)
			{
				List<Database> databases =
					...
					selectedFunctions.Select(x => x.Database)).Union(
		...
		private void Export_MultipleFiles_RelativeFolders()
		{
			...
			void serverGenerating(object sender1, ServerGeneratingEventArgs e1)
			{
				...
				if (String.IsNullOrEmpty(generator.Settings.POCO.Namespace) == false)
				{
					path = Path.Combine(
						path,
						String.Join("_", generator.Settings.POCO.Namespace.Split(Path.GetInvalidFileNameChars()))
					);
				}
			...
			void tableGenerating(object sender1, TableGeneratingEventArgs e1) => e1.Namespace = Export_MultipleFiles_RelativeFolders_GetNamespace(e1.Namespace, e1.Table.Database, "Tables", e1.Table.Schema);

			void complexTypeTableGenerating(object sender1, ComplexTypeTableGeneratingEventArgs e1) => e1.Namespace = Export_MultipleFiles_RelativeFolders_GetNamespace(e1.Namespace, e1.ComplexTypeTable.Database, "Tables", e1.ComplexTypeTable.Schema);

			void viewGenerating(object sender1, ViewGeneratingEventArgs e1) => e1.Namespace = Export_MultipleFiles_RelativeFolders_GetNamespace(e1.Namespace, e1.View.Database, "Views", e1.View.Schema);

			void procedureGenerating(object sender1, ProcedureGeneratingEventArgs e1) => e1.Namespace = Export_MultipleFiles_RelativeFolders_GetNamespace(e1.Namespace, e1.Procedure.Database, "Procedures", e1.Procedure.Schema);

			void functionGenerating(object sender1, FunctionGeneratingEventArgs e1) => e1.Namespace = Export_MultipleFiles_RelativeFolders_GetNamespace(e1.Namespace, e1.Function.Database, "Functions", e1.Function.Schema);

			void tvpGenerating(object sender1, TVPGeneratingEventArgs e1) => e1.Namespace = Export_MultipleFiles_RelativeFolders_GetNamespace(e1.Namespace, e1.TVP.Database, "TVPs", e1.TVP.Schema);
			...
			void complexTypeTablesGenerated(object sender1, ComplexTypeTablesGeneratedEventArgs e1) => path = Path.GetDirectoryName(path);
		...
		{
			if (rdbms is RDBMS.SQLServer or RDBMS.None)
			{
		...
		private UISettings GetUISettings()
		{
			return new UISettings() {
				...
				SupportSchema = generator == null || generator.Support.SupportSchema,
				SupportTVPs = generator == null || generator.Support.SupportTVPs,
				SupportEnumDataType = generator != null && generator.Support.SupportEnumDataType,
		...
		private void SerializeUISettings()
		{
			...
			throw new NotSupportedException($"{nameof(POCOGeneratorForm)}.{nameof(SerializeUISettings)}");
#else
			try
			{
